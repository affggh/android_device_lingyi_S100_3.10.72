...
cd ../..
cd frameworks/av
git apply -v ../../device/Infinix/x510/patches_3.18/0002-Use-hw-encoder-only-for-camera-fire855.patch
cd ../..
...
git apply -v ../../../device/Infinix/x510/patches_3.18/0001-Lunch-MiraVision-from-Settings.patch
cd ../../..
